...
class CustomerReview:
    """
    Customer Review from https://www.cs.uic.edu/~liub/FBS/CustomerReviewData.zip
    """
    
    resources = ('https://www.cs.uic.edu/~liub/FBS/CustomerReviewData.zip')
    ...
    @property
    def get_dict(self):
        paths = glob.glob(os.path.join(self.raw_folder, '*', '*'))
