...
resources = ('http://www.cs.jhu.edu/~mdredze/datasets/sentiment/unprocessed.tar.gz')

class MultiDomainSentiment:
    """
    dataset is downloaded from http://www.cs.jhu.edu/~mdredze/datasets/sentiment/ using unprocessed file.
    """
    resources = ('http://www.cs.jhu.edu/~mdredze/datasets/sentiment/unprocessed.tar.gz')
